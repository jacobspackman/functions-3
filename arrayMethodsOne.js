...
// CODE HERE
const evenNumbers = mixedNumbers.filter((e, i, a) => {
  return e % 2 === 0
})
...
// CODE HERE
const postTaxPrices = prices.map((e, i, a) => {
  return e * 1.07
} );
...
const totalPriceAfterTax = orders.map((e) => e.price + (e.price * e.tax))
...
const bobsTotal = purchases.filter(e => e.owner === "Bob").reduce((acc, curr) => acc + curr.price, 0)
